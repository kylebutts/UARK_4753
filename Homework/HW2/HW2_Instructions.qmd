...
This assignment will summarize the first part of the course. 
We have primarily studied how to use forecasting methods for cross-sectional data (i.e. data about individuals measured at a point in time). 
