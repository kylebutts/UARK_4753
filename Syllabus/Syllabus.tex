...
\begin{table}[!ht]
  ...
  \begin{tabular}{@{\extracolsep{5pt}} ll @{}}
    ...
    % \faClockO & 
    Lecture & Business Building 0340 MW 3:05-4:20pm \\
    % \faBuildingO & 
...
\begin{enumerate}
  ...
  \item Install Positron from \url{https://positron.posit.co/download.html}. 
\end{enumerate}
...
Your first assignment will be to download the software and compile an \texttt{.qmd} file.
...
It can be a very effective tutor, so ask it questions about the material!
