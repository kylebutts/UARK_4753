...
# %%
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/peyton_raw.pdf"),
  plot = plot_raw,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/peyton_monthly.pdf"),
  plot = plot_monthly,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/peyton_year_by_month.pdf"),
  plot = plot_year_by_month,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/peyton_season_effects.pdf"),
