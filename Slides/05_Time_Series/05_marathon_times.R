...
# %%
kfbmisc::tikzsave(
  here::here("Slides/05_Time_Series/figures/marathon_raw.pdf"),
  plot_raw,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here::here("Slides/05_Time_Series/figures/marathon_linear_trend.pdf"),
  plot_time_trend,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here::here("Slides/05_Time_Series/figures/marathon_piecewise_linear.pdf"),
  plot_piecewise_trends,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here::here(
    "Slides/05_Time_Series/figures/marathon_minutes_minus_linear_trend.pdf"
  ),
  plot_minutes_minus_linear_trend,
  width = 8,
  height = 4.2
