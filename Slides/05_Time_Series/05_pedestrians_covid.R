...
# %%
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/melbourne_pedestrians_raw.pdf"),
  plot = plot_raw,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/melbourne_pedestrians_monthly.pdf"),
  plot = plot_monthly,
  width = 8,
  height = 4.2
)
kfbmisc::tikzsave(
  here(
    "Slides/05_Time_Series/figures/melbourne_pedestrians_monthly_and_covid.pdf"
  ),
