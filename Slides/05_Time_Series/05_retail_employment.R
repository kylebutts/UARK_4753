...
# %%
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail.pdf"),
  plot = p_retail,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail_ses_alphas.pdf"),
  plot = p_retail_ses,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail_ma_2_by_12.pdf"),
  plot = p_retail_2_by_12,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail_detrended.pdf"),
  plot = p_retail_detrended,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail_seasonal.pdf"),
  plot = p_retail_seasonal,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/retail_resid.pdf"),
  plot = p_retail_resid,
  width = 8,
  height = 4.5
)
