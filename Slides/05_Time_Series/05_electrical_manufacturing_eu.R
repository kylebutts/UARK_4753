...
df <- read_csv(here(
  "Slides/05_Time_Series/data/electrical_manufacturing_eu.csv"
))
...
# %%
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_raw.pdf"),
  plot = p_raw_q,
  width = 8,
  height = 4.5
)
...
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_last.pdf"),
  plot = p_q_hat_last,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_avg_last_3.pdf"),
...
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_moving_average_3.pdf"),
  plot = p_q_hat_moving_avg_3,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_moving_average_9.pdf"),
  plot = p_q_hat_moving_avg_9,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_moving_average_25.pdf"),
...
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_ses_alpha_0_8.pdf"),
  plot = p_q_hat_ses_alpha_0_8,
  width = 8,
  height = 4.5
)
kfbmisc::tikzsave(
  here("Slides/05_Time_Series/figures/electrical_q_hat_ses_alphas.pdf"),
