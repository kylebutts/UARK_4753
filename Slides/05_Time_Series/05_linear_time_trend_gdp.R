...
df <- here("Slides/05_Time_Series/data/GDP.csv") |>
...
# %%
kfbmisc::tikzsave(
  here::here("Slides/05_Time_Series/figures/gdp_raw.pdf"),
  plot_raw,
  width = 8,
  height = 3.8
)
kfbmisc::tikzsave(
  here::here("Slides/05_Time_Series/figures/gdp_linear_trend.pdf"),
  plot_linear_trend,
  width = 8,
  height = 3.8
)
