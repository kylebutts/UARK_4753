...
df <- here("Slides/06_Time_Series_Regression/data/jewelry_retail_sales.csv") |>
...
# %% 
kfbmisc::tikzsave(
  here::here("Slides/06_Time_Series_Regression/figures/jewelry_sales_raw.pdf"),
  plot_raw, width = 8, height = 4.2
)
kfbmisc::tikzsave(
  here::here("Slides/06_Time_Series_Regression/figures/jewelry_sales_monthly_pattern.pdf"),
  plot_monthly_pattern, width = 8, height = 4.2
)
