...
\begin{enumerate}
  ...
  \begin{enumerate}[label=(\alph*)]
    \item Describe two ways you can help someone understand the distribution of a variable and what function you might use in \texttt{R} to do this.
    
    \item In your own words, describe what the concept of the sampling distribution of a statistic is. 
    Why is it helpful to know about the sample distribution of a statistic?

    \item Typically, we report 95\% confidence intervals. 
...
type::sandwich        26.93380    33.8516  0.795644 4.2901e-01 
  ...
  \begin{enumerate}[label=(\alph*)]
    \item What is the average amount of calories for food items in the `petite' type?
    
    \item Which food type has the largest number of calories on average?
    
    \item What is the difference in average amount of calories for `bistro box' foods relative to sandwiches? How would you modify this regression to test if the difference is statistically significant?
  \end{enumerate}
...
fat          11.2768    1.09564 10.29240 1.0109e-15 ***
  ...
  \begin{enumerate}[label=(\alph*)]
    \item Interpret the coefficient on `\texttt{fat}' in words. Comment on its statistical significance.
    
    \item Predict the number of calories in a food item with 14g of fat.

    \item Construct a 95\% confidence interval around the slope coefficient. 
...
carb         3.62562   0.202739 17.88319 < 2.2e-16 ***
  ...
  \begin{enumerate}[label=(\alph*)]
    \item[(d)] Why do you think the slope coefficient on `\texttt{fat}' went down after controlling for `\texttt{carb}'?
  \end{enumerate}
