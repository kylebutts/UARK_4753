...
rows <- here("R_Labs/Lab_09/data/bitcoin_daily.html") |>
  read_html() |>
  html_element("tbody") |>
  html_elements("tr")
...
fs::dir_create(here("R_Labs/Lab_09/data/"))
write_csv(
  bitcoin_prices,
  file = here("R_Labs/Lab_09/data/bitcoin_daily.csv")
)

# %%
bitcoin_prices <- read_csv(here("R_Labs/Lab_09/data/bitcoin_daily.csv"))
